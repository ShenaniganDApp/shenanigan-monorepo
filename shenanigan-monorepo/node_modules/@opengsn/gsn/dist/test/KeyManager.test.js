...
const keyStoreFilePath = workdir + '/' + KeyManager_1.KEYSTORE_FILENAME;
function cleanFolder() {
    if (fs_1.default.existsSync(keyStoreFilePath)) {
        fs_1.default.unlinkSync(keyStoreFilePath);
    }
...
contract('KeyManager', function (accounts) {
    describe('in-memory', () => {
        let mkm;
        before(() => {
            mkm = new KeyManager_1.KeyManager(10, undefined, 'seed1234');
        });
    ...
    describe('file-based KeyManager', () => {
        ...
        before('create key manager', function () {
            cleanFolder();
            fkmA = new KeyManager_1.KeyManager(20, workdir);
            assert.isTrue(fs_1.default.existsSync(workdir), 'test keystore dir should exist already');
        });
        ...
        it('should get the same key when reloading', () => {
            ...
            const fkmB = new KeyManager_1.KeyManager(20, workdir);

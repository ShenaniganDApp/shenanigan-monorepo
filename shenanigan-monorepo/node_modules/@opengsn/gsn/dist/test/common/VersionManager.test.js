...
const VersionsManager_1 = __importDefault(require("../../src/common/VersionsManager"));
describe('VersionManager', function () {
    context('constructor', function () {
        it('should throw on invalid semver string', function () {
            expect(function () {
                new VersionsManager_1.default('v.1.0');
            }).to.throw('Component version is not valid');
        });
        it('should not throw on valid semver string', function () {
            new VersionsManager_1.default('2.0.0-alpha.3+opengsn.something');
        });
    });
    context('#isMinorSameOrNewer()', function () {
        const manager = new VersionsManager_1.default('1.2.3');

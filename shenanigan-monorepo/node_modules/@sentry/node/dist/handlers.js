...
function tracingHandler() {
    return function sentryTracingMiddleware(req, res, next) {
        ...
        if (req.headers && utils_1.isString(req.headers['sentry-trace'])) {
            var span = tracing_1.Span.fromTraceparent(req.headers['sentry-trace']);
            if (span) {
...
function parseRequest(event, req, options) {
    ...
    if (options.request) {
        event.request = tslib_1.__assign(tslib_1.__assign({}, event.request), extractRequestData(req, options.request));
    }
